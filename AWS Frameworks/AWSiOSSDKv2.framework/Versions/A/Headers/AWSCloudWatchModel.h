 ...
 */
@interface AWSCloudWatchAlarmHistoryItem : AZModel
 ...
 */
@interface AWSCloudWatchDatapoint : AZModel
 ...
 */
@interface AWSCloudWatchDescribeAlarmHistoryOutput : AZModel
 ...
 */
@interface AWSCloudWatchDescribeAlarmsForMetricOutput : AZModel
 ...
 */
@interface AWSCloudWatchDescribeAlarmsOutput : AZModel
 ...
 */
@interface AWSCloudWatchDimension : AZModel
 ...
 */
@interface AWSCloudWatchDimensionFilter : AZModel
 ...
 */
@interface AWSCloudWatchGetMetricStatisticsOutput : AZModel
 ...
 */
@interface AWSCloudWatchListMetricsOutput : AZModel
 ...
 */
@interface AWSCloudWatchMetric : AZModel
 ...
 */
@interface AWSCloudWatchMetricAlarm : AZModel
 ...
 */
@interface AWSCloudWatchMetricDatum : AZModel
 ...
 */
@interface AWSCloudWatchStatisticSet : AZModel
